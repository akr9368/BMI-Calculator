...
function calculateBMI() {
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="canvas-social">
                <a href="https://www.facebook.com/Golds-Gym-Hazratganj-Lucknow-338851886789590/"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/goldsgymindia"><i class="fa fa-twitter"></i></a>
                <a href="https://www.youtube.com/c/GoldsGymChannel/featured"><i class="fa fa-youtube-play"></i></a>
                <a href="https://www.instagram.com/golds_hazratganj/?hl=en"><i class="fa fa-instagram"></i></a>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
                        ...
                        <p>Emphasizes fruits, vegetables, whole grains, and fat-free or low-fat milk and milk products.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="cs-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="chart-calculate-form">
                        <p>The Body Mass Index (BMI) is a quick way to assess your body size simply with your weight and height, regardless of your gender. Quickly calculate your BMI and find out which category you fall into.</p>
                        <form action="POST">
                            <div class="row">
                                <div class="col-sm-6">
    ...
    <section class="contact-section spad">
        <div class="container" id="foot">
            ...
            <div class="map" class="gs-item grid-wide set-bg">
                <iframe
                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28480.850888544464!2d80.85776679234704!3d26.83656916594853!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399bfe5d323b520b%3A0x2f011730d8522686!2sRajajipuram%2C%20Lucknow%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1628572191507!5m2!1sen!2sin"
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="fs-about">
                        ...
                        <p>The meaning of life is not simply to exist, to survive, but to move ahead, to go up, to conquer.<br>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="fs-widget">
                        <h4>Support</h4>
                        <ul>
                            <li><a href="https://www.facebook.com/Golds-Gym-Hazratganj-Lucknow-338851886789590/">Subscribe</a></li>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="copyright-text">
                        <p>
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved - AMIT || ARIF || AVNEESH || PRASHANT</a>
                                                   </p>
                    </div>
                </div>
            </div>
